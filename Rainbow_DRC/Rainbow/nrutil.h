...
#define EPS		(float)(2.e-6)    // floating point relative accuracy
...
int sum_smsm_(double scalar1, const double **matrix1_mxn, unsigned int m, unsigned int n, double scalar2, const double **matrix2_mxn, double **result_mxn); // s1*m1 + s2*m2
...
int aug_vv(float scalar, const float *vector1_nx1, unsigned int n, const float *vector2_nx1, float **result_nx2); // augment vectors
...
int aug_mm(float scalar, const float **matrix_mxn1, unsigned int m, unsigned int n1, const float **matrix_mxn2, unsigned int n2, float **result_mxn1n2); // augment matrices
int aug_mv(float scalar, const float **matrix_mxn, unsigned int m, unsigned int n, const float *vector_mx1, float **result_mxn1); // augment matrices
...
int my_qp(const float **A_mxn, int m, int n, float bu_mx1[], float bl_mx1[], int n_opt, float result_nx1[]);   
