...
BOOL CInitHUBO2Dlg::OnInitDialog() 
{
	...
	m_jointSelBox.InsertString(28, "RWY2");	
	m_jointSelBox.InsertString(29, "RF2");
	m_jointSelBox.InsertString(30, "RF3");	
	m_jointSelBox.InsertString(31, "RFA");
	//m_jointSelBox.InsertString(32, "RF5");
	m_jointSelBox.InsertString(32, "----");
	m_jointSelBox.InsertString(33, "LWY2"); // inhyeok, DRC
	m_jointSelBox.InsertString(34, "LF");	// inhyeok, DRC
	//m_jointSelBox.InsertString(35, "LF3");
	//m_jointSelBox.InsertString(36, "LF4");	
	//m_jointSelBox.InsertString(37, "LF5");
	m_jointSelBox.InsertString(35, "----");
	m_jointSelBox.InsertString(36, "----");	
	m_jointSelBox.InsertString(37, "----");
